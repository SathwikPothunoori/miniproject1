...
<body>
    ...
    <section id="main_section">
        ...
        <section id="matter">
            <h1 id ="Title">
                Electric Charging point and Recharge Management System
        <!-- <div>Travel Free</div><div>Of</div><div>Emission</div> -->
        
            </h1>


        </section>
        <img id="background" src="mainimage.png" alt="car_background">

        <!-- <img id="background" src="https://images.unsplash.com/photo-1593941707882-a5bba14938c7?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=872&q=80" alt="car_background"> -->
    ...
    <section class='goals'>
        ...
        <img src="shakehand-removebg-preview.png" alt="consumerpng">

              <!-- <img src="https://s.clipartkey.com/mpngs/s/20-203348_introductions-and-referrals-shaking-hands-drawing-easy.png" alt="consumerpng"> -->
            <h1>Consumer Insights</h1>
            <p>The company always collects the data and analyse the data of the users and modifies our plans according to the users comfort which makes our company best. </p>
        </div>
        <div>
            <img src="idea-removebg-preview.png" alt="ideapng">
            <h1>Emerging Ideas</h1>
            <p>We consider the new ideas of our employees which makes our company as a trend setter and it is the main reason for the growth of our company.</p>
        </div>
        <div  id='marketing'>
            <img src="marketing-removebg-preview.png" alt="marketingpng">
            <h1>Marketing Goals</h1>
            <p>Increase brand awareness,Become a thought leader,Increase customer value,Grow socialmedia presence ,Increase conversion rates are our marketing goals.</p>
        </div>
        <div>
            <img src="company-removebg-preview.png" alt="companypng">
            <h1>Company Insights</h1>
            <p>Our company seeks to hold a bunch of public no matter what new technologies come up in the market which helps in the stability of profits.</p>
        </div>
    </section>
    ...
    <section class='about_services'>
        <div id='about_our_company'>
            ...
            <div class="flex-child_img">
                <img src="aboutcompany.jpg" id='aboutcompany' alt="aboutcompany">
            </div>
            <div class="flex-child_content"> 
                <span>ABOUT OUR COMPANY</span>
                <p>Travel Free Of Emission is a company which belongs to electric automobile sector and provide various services and makes a user freindly environment.</p>
            </div>

        </div>
   
        <img src="visionmissionvalues.png" id='images3'alt="visionmissionvalues">
        

        <div id='services_we_provide'>
            <div class="flex-child_img">
                <img src="services.jpg" alt="services">
            </div>
            <div class="flex-child_content"> 
                <span>SERVICES WE PROVIDE</span>
                <p>We provide services to our customers with recharge points , provide the facility to find the nearest located recharge point of our company with help of Googlemaps and help them in giving suggestions while purchasing an electric car</p>
            </div>
        </div>
    </section>
    ...
    <section class='references'>
        ...
        <ul>
            <li><a class='glow' href="https://nexonev.tatamotors.com/?id=home" >Click here to visit TaTamotors website</a></li>
            <li><a  class='glow'href="https://www.tesla.com/">Click here to visit Tesla website</a></li>
            <li><a class='glow' href="https://www.mgmotor.co.in/vehicles/mgzsev">Click here to visit MGmotors website</a></li>
            <li><a class='glow' href="https://www.acko.com/car-guide/electric-car-buying-guide/">Check electric car buying guide by following this link</a></li>
...
<div class="footer-center">
    ...
    <div>
        ...
        <p><a href="mailto:tfoeoffical@gmail.com">tfoeofficial@gmail.com</a></p>
    </div>
</div>
